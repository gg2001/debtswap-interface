...
const addresses: { [key: number]: Addresses } = {
  1: {
...
export const checkUnavailableBorrow: {
  [key: number]: { [key: string]: { [key: string]: boolean } };
} = {
  1: {
    sUSD: { stable: false, variable: true },
    UNI: { stable: false, variable: true },
    BUSD: { stable: false, variable: true },
    GUSD: { stable: false, variable: true },
    YFI: { stable: false, variable: true },
    SNX: { stable: false, variable: true },
    CRV: { stable: false, variable: true },
    BAL: { stable: false, variable: true },
    xSUSHI: { stable: false, variable: true },
  },
  137: {
    WMATIC: { stable: false, variable: true },
    DAI: { stable: false, variable: true },
    USDC: { stable: false, variable: true },
    USDT: { stable: false, variable: true },
    WETH: { stable: false, variable: true },
    WBTC: { stable: false, variable: true },
  },
};

export const tokenList: { [key: number]: string[] } = {
  1: [
    "USDT",
    "WBTC",
    "WETH",
  ...
  2: ["DAI", "USDC", "USDT", "WBTC", "WETH", "WMATIC"],
};
